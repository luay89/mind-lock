...
${seq.join(', ')}, ؟`,
    ...
    function genLogicOrder(names) {
        // نمط منطقي بسيط: A أكبر من B، و B أكبر من C
        const [a, b, c] = names;
        return {
...
من هو الأصغر؟`,
    ...
    function genAnalysisPattern(a, b, c) {
        // نمط: إذا كان 1->a، 2->b، 3->c، ما قيمة 4؟ (قاعدة + ثابت)
        const k = b - a;
        const correct = c + k;
        return {
            q: `تحليل: إذا كان\n1 ↦ ${a}\n2 ↦ ${b}\n3 ↦ ${c}\n\nفما قيمة 4 ↦ ؟`,
    ...
    function buildQuestions() {
        ...
        for (let level = 1; level <= 30; level++) {
            ...
            for (let i = 0; i < 10; i++) {
                ...
                // أرقام شبه ثابتة لضمان تنويع جيد بين المستويات
                ...
                if (type === 'math') {
                    if (band.band === 'easy') {
                        ...
                        // تأكد أن b مناسب: 2x + a = b مع x صحيح
    ...
    // تصدير الأسئلة بشكل عالمي (بدون Modules)
