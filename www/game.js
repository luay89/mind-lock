...
const GameState = {
    ...
    /**
     * الحصول على بيانات السؤال الحالي (يُعرض كـ "مستوى" في الواجهة)
     */
    getCurrentLevelData() {
    ...
    /**
     * الحصول على بيانات السؤال الحالي مع تطبيق تدرج صعوبة ملموس
     */
    getCurrentQuestionData() {
        ...
        const progressiveReduction = Math.min((level - 1) * 0.03, 0.55);
